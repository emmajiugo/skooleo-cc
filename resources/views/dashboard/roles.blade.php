                        ...
                        <div class="col-12">
                            <div class="card" style="min-height:400px">
                                <div class="card-header">
                                    <h4 class="card-title">Setup Roles</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        @isset($message)
                                            ...
                                            <br>
                                        @endisset
                                        <form class="row" action="{{ route('set.roles') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="col-md-7 form-group">
                                                <input type="submit" class="btn btn-danger btn-block" value="Set Role">
                                            </div>
                                        </form>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="{{route('delete.roles', $role->id)}}" method="POST">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    {!! ($role->name!="super admin") ? '<input type="submit" name="delete" class="btn btn-sm btn-danger" value="Delete">':'' !!}
                                                                </form>
                                                            </td>
                                                        </tr>
                                                        @endforeach
